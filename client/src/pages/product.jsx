        ...
        <Container>
            ...
            <ProductContainer>
                ...
                <ProductInfo>
                    ...
                    <ProductWish>
                        <FavoriteBorder style={{ marginLeft: "10px", padding: "5px", cursor: "pointer" }} />
                        <AddToCartButton>Add to Cart</AddToCartButton>
                        <BuyButton>Buy Now</BuyButton>
                    </ProductWish>
                    <ProductAbout>
                        <h3>Customer Reviews</h3>
                        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Veritatis facilis pariatur nihil deleniti repellendus nulla vero quo? Quam, molestiae ex qui itaque commodi dolore praesentium inventore fugit velit saepe, cumque vitae repudiandae eius dignissimos? Porro odit ut modi deserunt, optio tenetur, dolor necessitatibus, officia tempore dignissimos obcaecati culpa accusantium minima.
                        </p>
